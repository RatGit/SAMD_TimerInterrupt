/**
 * This is a modified version of the Adafruit ZeroTimer library.
 * Modified by Matthew Cochrane in 2018.
 * The library now supports choosing which Generic Clock Generator is used to run each timer.
 * Note that timers 2 and 3 are sourced from the same GCLK as are timers and 4 and 5.
 * NOTE: Added functionality DOES NOT WORK FOR SAMD51!! Only SAMD21.
 */
#include "Arduino.h"
...
class Adafruit_ZeroTimer {
 public:
  Adafruit_ZeroTimer(uint8_t tn, uint8_t gclkgen);
