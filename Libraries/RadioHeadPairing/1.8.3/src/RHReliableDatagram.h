...
#define RH_DEFAULT_TIMEOUT 1000  // 200

/// The default number of retries
#define RH_DEFAULT_RETRIES 6  // 3
...
public:
    ...
    bool sendtoWait(uint8_t* buf, uint8_t len, uint8_t address, uint16_t atimeout);
...
protected:
    ...
    void acknowledge(uint8_t id, uint8_t from, uint16_t timeout);
